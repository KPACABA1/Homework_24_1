...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        course = Course.objects.create(title='test_course', description='test_description')
        lesson = Lesson.objects.create(title='test_lesson', description='test_description', course=course)
