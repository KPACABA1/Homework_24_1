...
class Course(models.Model):
    ...
    creator = models.ForeignKey(AUTH_USER_MODEL, on_delete=models.SET_NULL, verbose_name='Создатель', related_name='user_course',
...
class Lesson(models.Model):
    ...
    creator = models.ForeignKey(AUTH_USER_MODEL, on_delete=models.CASCADE, verbose_name='Создатель', related_name='user_lesson',
                                null=True, blank=True)
